...
// consumed via named imports; the factory itself is intentionally a no-op.
...
export const THEME_MAP: Record<string, string> = {
    ...
    "theme-cycler":       "dark",              // neutral start — user cycles from here
...
export function applyExtensionTheme(fileUrl: string, ctx: ExtensionContext): boolean {
    ...
    if (!result.success && themeName !== "dark") {
        return ctx.ui.setTheme("dark").success;
    }
